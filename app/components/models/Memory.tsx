...
export function Memory(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF(withBase('models/dalithe_persistence_of_memory.glb')) as GLTFResult
  return (
...
useGLTF.preload(withBase('models/dalithe_persistence_of_memory.glb'))
